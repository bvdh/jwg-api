...
- Authorization
  - [HL7 SMART Backend Services](https://hl7.org/fhir/smart-app-launch/) - Defines authorization in FHIR. We use the SMART Backend Services profile for system-system authorization, and FHIR scopes. This specification is compatible with [IHE IUA](https://profiles.ihe.net/ITI/IUA/index.html)
- [IHE IUA](https://profiles.ihe.net/ITI/IUA/index.html) which defines authorization and access control actors and mechanisms. We use the actors and transactions model.
